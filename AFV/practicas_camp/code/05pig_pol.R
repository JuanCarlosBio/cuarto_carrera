...
pig_pol_pino <- read_csv("data/pig_polifenoles_pino.csv")
...
ggsave("results/plots/pigmentos_polifenoles/14NBI.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/15clorofila.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/16flavonoides.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/17antocianinas.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/18pca_pigmentos_polifenoles.png",
       width = 7,
       height = 5)
...
pig_pol_rosalillo <- read_csv("data/pig_polifenoles_rosalillo.csv") 
...
ggsave("results/plots/pigmentos_polifenoles/19NBI_hoja_rosalillo.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/20nivel_colorfilas.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/21flavos_hoja_rosalillo.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/22antos_hoja_rosalillo.png",
       width = 7,
       height = 5)
...
ggsave("results/plots/pigmentos_polifenoles/23pca_pigmentos_fenoles.png",
       width = 7,
       height = 5)
