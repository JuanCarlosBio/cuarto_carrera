...
ggsave("results/plots/ecofisiologia/prunus1.png",
      width = 7, 
      height = 4.5)
...
ggsave("results/plots/ecofisiologia/prunus2.png",
       width = 7, 
       height = 4)
...
ggsave("results/plots/ecofisiologia/vinatigo1.png",
       width = 7, 
       height = 4)
...
ggsave("results/plots/ecofisiologia/inatigo3.png",
       width = 7, 
       height = 4)
