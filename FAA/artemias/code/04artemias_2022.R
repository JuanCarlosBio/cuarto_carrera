...
artemias_2022_csv <- read_csv("artemias/data/artemias_2022.csv")
...
ggsave("artemias/results/plots/artemias_2022.png",
       width = 9.5,
       height = 6)
...
# write_csv(cp_2022, "artemias/data/cp_2022.csv")
...
ggsave("artemias/data/artemias_pca2022.png", 
       width = 7, 
       height = 4.75)
