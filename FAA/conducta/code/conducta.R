...
conducta <- read_csv("conducta/data/conducta_ratones.csv")
...
om_cow = plot_grid(of1,of2,of3,
                   labels = c("A","B","C"))

 ggsave("conducta/results/plots/om.png", 
        plot = om_cow, 
        width = 8.5, 
        height = 6)
...
hm_plot <- holes_maze %>%
 ...
 ggsave("conducta/results/plots/hm.png", 
        plot = hm_plot, 
        width = 8.5, 
        height = 6)
...
pmix <- plot_grid(pmix1,pmix2, nrow = 2)

ggsave("conducta/results/plots/pm.png", 
       plot = pmix, 
       width = 8.75, 
       height = 6)
...
ggsave("conducta/results/plots/obs_esp.png", 
       plot = p.maze_plot, 
       width = 8.75, 
       height = 6)
...
pca_cow <- plot_grid(pc_1, pc_2, pc_3)

ggsave("conducta/results/plots/pc_ratones.png", 
       plot = pca_cow, 
       width = 8, 
       height = 7)
...
rca <- as_tibble(of_varimax$scores) %>% 
  mutate(v_j=matrix_of$v_j) %>%
...
ggsave("conducta/results/plots/rca.png", 
       plot = rca, 
       width = 8, 
       height = 7)
